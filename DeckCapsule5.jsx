...
import good1 from "./picture/good1.jpg";
import good2 from './picture/good2.jpg';
import good3 from './picture/good3.png';
import good4 from './picture/good4.png';
...
const galleryImages = [
  { title: "Exterior Resort Setup Grid View", src: good1 },
  { title: "Twin Sphere Modular High Angle Mountain Ridge", src: good2 },
  { title: "Interior Panoramic Dome View Frame", src: good3 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: good4 }
];
  const productVideos = [
    { id: 1, title: "E20 Introduction Video", duration: "1:12" },
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start animate-layout-up">
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 leading-tight">
            Luxury Awaits in D8 IDONGSIK House
          </h1>
          <p className="text-slate-500 text-[15px] md:text-[20px] leading-relaxed max-w-2xl mx-auto lg:mx-0">
            The overall framework is constructed with simple and clear lines. The twobedroom-one-bathroom layout boasts a high space utilization rate and an excellent cost-performance ratio!
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
           <div className="text-center mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-semibold tracking-tight text-slate-900">The Science Behind Our IDONGSIK Designs</h2>          
             ...
             <p className="text-[15px] w-[300px] sm:text-[20px] ml-auto mr-auto pt-[20px] font-semibold  tracking-tight text-slate-500">
              Our D8 space IDONGSIK are designed to 
