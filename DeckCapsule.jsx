...
import rocky from "./picture/rocky.jpg";
...
const galleryImages = [
  ...
  const productVideos = [
    { id: 1, title: "C5 Introduction Video", duration: "1:12" },
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className=" w-full text-center mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-semibold tracking-tight text-slate-900">Our Features That Redefine Luxury</h2>          
             ...
             <p className="text-[15px]sm:text-[20px] pt-[20px] font-semibold  tracking-tight text-slate-500">
              Our double deck space IDONGSIK are designed
