...
import star from "./picture/star.jpg";
...
import snow11 from "./picture/snow11.png";
import snow22 from "./picture/snow22.png";
import snow33 from "./picture/snow33.jpg";
import Home6 from "./Home6";
import Home7 from "./Home7";
import Home8 from "./Home8";
import DeckCapsule1 from "./DeckCapsule1";
  ...
  return (
    <aside>
      ...
      >
        ...
        {/* ---------------- MAIN HERO CONTENT ---------------- */}
        <main className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 px-16 pt-27 md:pt-40 flex flex-col justify-between min-h-[calc(100vh-90px)]">
            ...
            <table className="w-full border-collapse text-xs md:text-sm">
              <tbody>
                ...
                <tr className="border-b border-slate-100">
                  <td
                    rowSpan={6}
                    className="text-[15px] md:text-[20px] w-[20%] text-orange-500 font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200"
                  >
                    Specifications
                  </td>
                ...
                <tr className="border-b border-slate-100">
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700">
                    ...
                    High-temperature coating on aluminum plate
                  </td>
                </tr>
                ...
                <tr className="border-b border-slate-100">
                  <td
                    rowSpan={6}
                    className="text-[15px] md:text-[20px] text-orange-500 font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200"
                  >
                    Glass
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 border-b border-slate-100">
                ...
                <tr className="border-b border-slate-200">
                  <td className=" text-[15px] md:text-[20px] text-orange-500 font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200">
                    Fixing Method
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-4 text-slate-500 leading-relaxed font-medium">
                    ...
                    provided site drawings and templates, fixed with
                    high-strength bolts.
                  </td>
                </tr>
