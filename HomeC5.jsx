...
import prodo1 from "./picture/prodo1.png";
import prodo2 from "./picture/prodo2.png";
import prodo3 from "./picture/prodo3.jpg";
...
const HomeC5 = () => {
  ...
  const testimonials = [
    ...
    {
      text: "We were struggling with all the costs and waiting for construction to finish. When we tried IDONGSIK JUTAEK's modular space IDONGSIKs, things changed. They were quick to set up and cost way less. Our visitors can't get enough of the Star Double Deck — the views are amazing! The whole thing's been a hit, and our camp is busier than ever.",
      name: "Maria Kostas",
      role: "Camp Owner",
    },
    {
  ...
  return (
    <aside>
      ...
      >
        ...
        {/* ---------------- MAIN HERO CONTENT ---------------- */}
        <main className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 px-16 pt-27 md:pt-38 flex flex-col justify-between min-h-[calc(100vh-90px)]">
          <div className="max-w-4xl space-y-9">
            ...
            <div className="flex justify-center md:block">
              <button
                ...
                className="bg-orange-500 text-white px-9 py-4 rounded text-slx font-semibold tracking-wider btn-hover-lift animate-bounce-in"
              >
                Request a Quote
              </button>
            </div>
      ...
      <DeckCapsule />
      <div className="bg-white font-sans text-slate-800 antialiased py-16 px-4 min-h-screen ">
        <div className="max-w-8xl mx-auto text-center">
          {/* Section Header */}
          <p className="text-[15px] md:text-[20px] text-orange-500 font-bold uppercase tracking-widest mb-2">
            PRODUCT SPECIFICATIONS
          </p>
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 mb-10">
            The Science Behind Our IDONGSIK Designs
          </h1>

          {/* Main Parameters Table Wrapper */}
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm text-left">
            {/* Table Subtitle Banner */}
            <div className="border-b border-slate-200 bg-white px-6 py-4">
              <p className="text-[15px] md:text-[20px] text-orange-500 font-bold uppercase tracking-wider">
            ...
            <table className="w-full border-collapse text-xs md:text-sm">
              <tbody>
                ...
                <tr className="border-b border-slate-100">
                  <td
                    rowSpan={6}
                    className="text-[15px] md:text-[20px] w-[20%] text-black font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200"
                  >
                    Specifications
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 border-b border-slate-100">
                    <span className="text-[15px] md:text-[20px] font-semibold text-slate-900">
                      Dimensions:
                    </span>{" "}
                    Diameter 4.16 meters
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className=" text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700">
                    <span className=" text-[15px] md:text-[20px] font-semibold text-slate-900">
                      Body Height:
                    </span>{" "}
                    4.5 meters
                ...
                <tr className="border-b border-slate-100">
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700">
                    ...
                    140mm diameter seamless circular tube + 20mm thick steel
                    plate
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                ...
                <tr className="border-b border-slate-100">
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700">
                    <span className="text-[15px] md:text-[20px] font-semibold text-slate-900">
                      Surface Treatment of Profilest:
                    </span>{" "}
                    High temperature fluorocarbon coating
                  </td>
                </tr>
                <tr className="border-b border-slate-200">
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700">
                    ...
                    Galvanized pipe + waterproof board + OSB (Oriented Strand
                    Board) + aluminum plastic board+floor
                  </td>
                </tr>
                ...
                <tr className="border-b border-slate-100">
                  <td
                    rowSpan={6}
                    className="text-[15px] md:text-[20px] text-black font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200"
                  >
                    Glass
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 border-b border-slate-100">
                ...
                {/* ================= FIXING METHOD SECTION ================= */}
                <tr className="border-b border-slate-200">
                  <td className=" text-[15px] md:text-[20px] text-black font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200">
                    Fixing Method
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-4 text-slate-500 leading-relaxed font-medium">
                    Concrete platform with reserved bolt holes according to
                    provided site drawings and templates, using high -strength
                    bolts for fixation.
                  </td>
                </tr>

                {/* ================= REFERENCE DRAWING (PICTURE SLOTS) SECTION ================= */}
                <tr>
                  <td className="text-[15px] md:text-[20px] text-black font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200">
                    Reference drawing
                  </td>
                  <td className="px-6 py-6 bg-slate-50/50">
                    {/* Flex container holding the slots where you can add your component layout images */}
                    <div className="flex flex-wrap gap-5 items-center justify-around">
                      {/* Picture Slot 1 */}
                      <div className="w-40 h-40 flex flex-col items-center justify-center text-center shadow-sm cursor-pointer">
                        <div className="rounded-lg w-full h-28 flex items-center justify-center mb-2 group-hover:bg-orange-50/30 transition-colors"></div>
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider group-hover:text-orange-500 transition-colors">
                          <img src={prodo1} alt="" />
                        </span>
                      </div>
      ...
      <div className="bg-white font-sans text-slate-800 antialiased py-16 px-4 min-h-screen">
        <div className="max-w-8xl mx-auto text-center">
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm text-left">
            <table className="w-full border-collapse text-xs md:text-sm">
              <thead>
                <tr className="bg-slate-50/70 border-b border-slate-200 text-orange-500 font-bold uppercase tracking-wider text-[11px] md:text-xs">
                  <th className="text-[15px] md:text-[20px] w-[20%] px-6 py-4 border-r border-slate-200 font-bold text-left">
                    Category
                  </th>
                  <th className="text-[15px] md:text-[20px] w-[25%] px-6 py-4 border-r border-slate-200 font-bold text-left">
                    Configuration
                  </th>
                  <th className="text-[15px] md:text-[20px] w-[43%] px-6 py-4 border-r border-slate-200 font-bold text-left">
                    Configuration Description
                  </th>
                  <th className="text-[15px] md:text-[20px] w-[12%] px-6 py-4 font-bold text-left">
                    Quantity
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-slate-200">
                  <td
                    rowSpan={6}
                    className="text-orange-500 font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200 text-[15px] md:text-[20px] bg-slate-50/20"
                  >
                    Structural System
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 font-medium border-r border-slate-200 border-b border-slate-100">
                    Structural System
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Framework structure with wooden frame system
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                </tr>
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Steel support with external cladding
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    3 sets
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Aluminum single plate decorative panel modules
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    65 pieces
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Composite wood grain panel / tempered glass
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 font-medium border-r border-slate-200">
                    Entrance Door
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200">
                    Remote-controlled opening and closing
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium">
                    1 set
                  </td>
                </tr>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    High-grade SPC waterproof floor
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Integrated bathroom (including sink, faucet, shower head,
                    toilet, and floor drain)
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Remote-controlled LED dimmable ceiling lights
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  <td className="text-[15px] md:text-[20px] text-[15px] md:text-[20px]px-6 py-3.5 text-slate-700 font-medium border-r border-slate-200 border-b border-slate-100">
                    Ventilation
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Aluminum track panoramic curtains
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200 border-b border-slate-100">
                    Double-glazed Low-e glass (Panoramic Window)
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium border-b border-slate-100">
                    1 set
                  </td>
                ...
                {/* ================= SUPPORT ================= */}
                <tr className="border-b border-slate-200">
                  <td className="text-orange-500 font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200 text-[15px] md:text-[20px] bg-slate-50/20">
                    Support
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 font-medium border-r border-slate-200">
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-700 font-medium border-r border-slate-200">
                    Hooks / Connectors / Transport Packaging Film
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 border-r border-slate-200">
                    Hooks, connectors, and transport packaging film
                  </td>
                  <td className="text-[15px] md:text-[20px] px-6 py-3.5 text-slate-600 font-medium">
                    1 set
                  </td>
      ...
      <div className="pt-15 flex flex-col lg:flex-row justify-center lg:justify-between max-w-6xl mx-auto w-full gap-12">
        ...
        <div
          className="w-full lg:w-[45%] pt-5 lg:pt-15 space-y-8 text-center lg:text-left"
        >
          <div>
            ...
            <p className="text-[15px] md:text-[20px] mt-4 text-gray-500 leading-relaxed">
              Please fill out the form for any inquiries, and our team will get
              back to you.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 lg:text-left">
            ...
            <div className="flex items-center lg:items-start justify-center lg:justify-start space-x-3">
              ...
              <div>
                <h4 className=" text-[15px] md:text-[20px] font-semibold text-gray-900 ">
                  Email Us
                </h4>
                <a
                  href="mailto:IDONGSIKJUTAEK@gmail.com"
                  className="text-[10px] md:text-[15px] text-gray-500 hover:text-orange-500 transition-colors break-all"
                >
              ...
              <div className="text-orange-500 mt-1 shrink-0">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-2.824-1.48-5.144-3.8-6.62-6.62l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"
                  />
                </svg>
              </div>
              <div>
              ...
              <div className="text-orange-500 mt-1 shrink-0">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 20.25c4.97 0 9-4.03 9-9s-4.03-9-9-9-9 4.03-9 9c0 2.12.735 4.07 1.961 5.618l-1.025 3.73 3.84-1.007A8.963 8.963 0 0012 20.25z"
                  />
                </svg>
              </div>
              <div>
          ...
          <div  ref={contactSectionRef} className="flex items-center lg:items-start justify-center lg:justify-start space-x-3 pt-2 border-t border-gray-200">
            <div className="text-orange-500 mt-1 shrink-0">
              <svg
                className="w-8 h-11"
                fill="none"
            ...
            <div>
              ...
              <p className="text-[10px] md:text-[15px] text-gray-500 leading-relaxed max-w-sm">
                Jingxu Space Company, Huanglou Town, Qingzhou City, Shandong
                Province, China
              </p>
            </div>
          </div>
        ...
        <div className="w-full lg:w-[45%] pt-5 lg:pt-15 space-y-8 bg-white p-6 sm:p-10 rounded-xl border border-gray-100 shadow-sm mx-auto lg:mx-0">
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              <input
                ...
                id="productName"
                name="productName"
                defaultValue="Double Deck Space IDONGSIK"
