...
import coolest from "./picture/coolest.jpg";
import nice1 from "./picture/nice1.png";
import nice2 from './picture/nice2.png';
import nice3 from './picture/nice3.jpg';
import nice4 from './picture/nice4.png';
import nice5 from './picture/nice5.jpg';
import nice6 from "./picture/nice6.jpg";
...
const galleryImages = [
  { title: "Exterior Resort Setup Grid View", src: nice1 },
  { title: "Twin Sphere Modular High Angle Mountain Ridge", src: nice2 },
  { title: "Interior Panoramic Dome View Frame", src: nice3 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: nice4 },
  { title: "Top Tier Double Deck Symmetrical Dining Area", src: nice5 },
  { title: "Night Sky Starry Backdrop Long-Exposure Frame", src: nice6 }
];
  const productVideos = [
    { id: 1, title: "D7 Introduction Video", duration: "1:12" },
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start animate-layout-up">
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 leading-tight">
            Luxury Awaits in D5 IDONGSIK House
          </h1>
          <p className="text-slate-500 text-[15px] md:text-[20px] leading-relaxed max-w-2xl mx-auto lg:mx-0">
            The D5 is a smaller version of the D7, with the same width and height but a shorter length of 8.5m (vs. 11.5m). It offers a more affordable price. The spaceship-inspired design includes one bedroom with 270-degree floor-toceiling windows, one bathroom, and an oversized balcony for great views.
         </p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-6 text-left max-w-xl mx-auto lg:mx-0">
            <div className="p-4 border border-slate-100 bg-slate-50/50 rounded-xl">
              ...
              <p className="text-sm sm:text-[12px] text-slate-500 mt-1">Fits 3 units per 40ft container.</p>
            </div>
            <div className="p-4 border border-slate-100 bg-slate-50/50 rounded-xl">
      ...
      <section className=" py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
           <div className="text-center mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-semibold tracking-tight text-slate-900">Our Features That Redefine Luxury</h2>          
            </div>
             <p className="text-[30px] sm:text-[20px] ml-auto mr-auto pt-[20px] font-semibold w-[500px] tracking-tight text-slate-500">
              Our D5 space IDONGSIK are designed to 
               <br/>
              elevate your experience with exceptional 
              <br/>
              quality and unmatched performance.  
              <br/>
              Explore how this solution redefines
              <br/>
              convenience and brings lasting 
              <br/>
              value to your everyday needs.            </p>
          </div>
