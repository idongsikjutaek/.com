...
import nice3 from "./picture/nice3.jpg";
...
import nice11 from "./picture/nice11.png";
import nice22 from "./picture/nice22.png";
import Home6 from "./Home6";
import Home7 from "./Home7";
import Home8 from "./Home8";
import DeckCapsule3 from "./DeckCapsule3";
            ...
            <table className="w-full border-collapse text-xs md:text-sm">
              <tbody>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td
                    rowSpan={6}
                    className="text-[15px] md:text-[20px] text-orange-500 font-bold uppercase tracking-wider px-6 py-4 align-top border-r border-slate-200 text-[11px] md:text-xs bg-slate-50/10"
                  >
                    Specifications
                  </td>

                  {/* Unified Parameter Value Column */}
                  <td className="px-6 py-3.5 text-slate-700 font-medium border-r border-slate-200 border-b border-slate-100 leading-relaxed">
                    <span className="text-[15px] md:text-[20px] text-slate-900">
                      Product Model:
                    </span>{" "}
                    D-05
                  </td>
