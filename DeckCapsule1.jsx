...
import snow1 from "./picture/snow1.png";
import snow2 from './picture/snow2.jpg';
import snow3 from './picture/snow3.jpg';
import snow4 from './picture/snow4.jpg';
import snow5 from './picture/snow5.jpeg';
import snow6 from "./picture/snow6.jpeg";
...
const galleryImages = [
  { title: "Exterior Resort Setup Grid View", src: snow1 },
  { title: "Twin Sphere Modular High Angle Mountain Ridge", src: snow2 },
  { title: "Interior Panoramic Dome View Frame", src: snow3 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: snow4 },
  { title: "Top Tier Double Deck Symmetrical Dining Area", src: snow5 },
  { title: "Night Sky Starry Backdrop Long-Exposure Frame", src: snow6 }
];
  const productVideos = [
    { id: 1, title: "C7 Introduction Video", duration: "1:12" },
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start animate-layout-up">
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          <span className="text-[13px] text-orange-500 sm:font-bold uppercase tracking-widest text-[15px] block">
           Spacious Dome Retreat
          </span>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 leading-tight">
            Discover Opulence in 
            <br/>
            Single Deck IDONGSIK
          </h1>
          <p className="text-slate-500 text-[15px] md:text-[20px] leading-relaxed max-w-2xl mx-auto lg:mx-0">
            The single storey Star model offers a spacious interior of 3.5m height and a stunning dome design, creating a luxurious living experience. The layout includes a standard hotel bed, a dry and wet separation bathroom, and a separate wash area with a basin and bathtub, making it the perfect choice for high-end camping accommodations with comfort and elegance.          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-semibold tracking-tight text-slate-900">The Science Behind Our IDONGSIK Designs</h2>          
             ...
             <p className="text-[18px] w-[300px] md:text-[20px] ml-auto mr-auto pt-[20px] font-semibold tracking-tight text-slate-500">
              Our single deck space IDONGSIK are[500px
              designed to elevate your experience 
              with exceptional quality and unmatched 
              performance. Explore how this solution 
              redefines convenience and brings  
              lasting value to your everyday needs.           
             </p>
          </div>
