...
import pic from "./picture/pic.jpg";
...
import pic6 from "./picture/pic6.png";
...
const galleryImages = [
  { title: "Exterior Resort Setup Grid View", src: pic1 },
  { title: "Twin Sphere Modular High Angle Mountain Ridge", src: pic2 },
  { title: "Interior Panoramic Dome View Frame", src: pic3 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: pic4 },
  { title: "Top Tier Double Deck Symmetrical Dining Area", src: pic5 },
  { title: "Night Sky Starry Backdrop Long-Exposure Frame", src: pic6 }
];
  const productVideos = [
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start animate-layout-up">
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 leading-tight">
            Luxury Awaits in D7 IDONGSIK House
          </h1>
          <p className="text-slate-500 text-[15px] md:text-[20px] leading-relaxed max-w-2xl mx-auto lg:mx-0">
            The classic two-bedroom-one-bathroom design, with 270-degree floor-to-ceiling windows in both rooms and a large balcony, offers a panoramic view. Suitable for hotels, guesthouses or personal use, it provides the feeling of living in the scenery, whether by the sea, lakeside, in the mountains or desert.          </p>
           ...
           <div className="text-center mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-semibold tracking-tight text-slate-900">The Science Behind Our IDONGSIK Designs</h2>          
             ...
             <p className="text-[30px] sm:text-[20px] ml-auto mr-auto pt-[20px] font-semibold w-[500px] tracking-tight text-slate-500">
              Our D7 space IDONGSIK are designed to
               <br/>
