...
import nightt from "./picture/nightt.jpg";
...
import cool11 from "./picture/cool11.jpg"
import cool22 from "./picture/cool22.png"
import cool33 from "./picture/cool33.png"
import Home6 from "./Home6";
import Home7 from "./Home7";
import Home8 from "./Home8";
import DeckCapsule2 from "./DeckCapsule2";
              ...
              <tbody>
                ...
                <tr className="border-b border-slate-200">
                  ...
                  <td className="text-[15px] md:text-[20px] px-6 py-4 text-slate-500 leading-relaxed font-medium">
                    Concrete platform with reserved bolt 
                    holes according to provided site 
                    drawings and templates, fixed with 
                    high-strength bolts.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="px-6 py-6 bg-slate-50/50">
                    ...
                    <div className="w-40 h-40 flex flex-col items-center justify-center text-center shadow-sm cursor-pointer">
                      <div className="rounded-lg w-full h-28 flex items-center justify-center mb-2 group-hover:bg-orange-50/30 transition-colors">
                      </div><span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider group-hover:text-orange-500 transition-colors"><img src={cool11} alt="" /></span>
                    </div>
                    ...
                    <div className="w-40 h-40 flex flex-col items-center justify-center text-center shadow-sm cursor-pointer">
                      ...
                      <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider group-hover:text-orange-500 transition-colors"><img src={cool22} alt="" /></span>
                    </div>
                    ...
                    <div className="w-40 h-40 flex flex-col items-center justify-center text-center shadow-sm cursor-pointer">
                      ...
                      <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider group-hover:text-orange-500 transition-colors"><img src={cool33} alt="" /></span>
                    </div>
