...
import love4 from "./picture/love4.jpg";
import love11 from "./picture/love11.png";
import love6 from "./picture/love6.png";
import { Link } from "react-router-dom";
import useLogoSpin from "./hooks/useLogoSpin";
import "./styles/pageAnimations.css";
import good11 from "./picture/good11.png";
import good3 from "./picture/good3.png";
import Home6 from "./Home6";
import Home7 from "./Home7";
import Home8 from "./Home8";
import DeckCapsule6 from "./DeckCapsule6";
...
const Home20 = () => {
  ...
  return (
    <aside>
      ...
      <div className="relative min-h-screen bg-white p-4 flex flex-col items-center justify-center font-sans antialiased selection:bg-orange-200">
        {/* Main Container Table */}
        <div className="w-full max-w-8xl bg-[#f4f7fa] border border-[#cbd5e1] text-[#334155] text-sm md:text-base shadow-sm">
          {/* Header Row */}
          <div className="w-full py-4 text-center border-b border-[#cbd5e1] bg-[#fdfefe]">
            <h2 className="text-orange-500 font-semibold tracking-wide uppercase text-base text-[15px] md:text-[20px]">
              Expandable House E20 Parameters
            </h2>
          </div>

          {/* Row 1: Product Model & Occupied Area */}
          <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#cbd5e1]">
            {/* Product Model */}
            <div className="grid grid-cols-3 border-b md:border-b-0 md:border-r border-[#cbd5e1]">
              <div className="col-span-1 p-4 bg-[#fdfefe] text-[15px] md:text-[20px] bg-transparent font-medium text-orange-500 flex items-center">
                Product Model
              </div>
              <div className="col-span-2 p-4 flex items-center bg-[#fdfefe] md:bg-transparent">
                20-Foot Double-Wing Expansion Container
              </div>
            </div>
            {/* Occupied Area */}
            <div className="grid grid-cols-3">
              <div className="text-[15px] md:text-[20px] text-orange-500 col-span-1 p-4 font-medium  flex items-center">
                Occupied Area
              </div>
              <div className="col-span-2 p-4 flex items-center">37m²</div>
            </div>
          </div>

          {/* Row 2: Folded Dimensions & Expanded Dimensions */}
          <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#cbd5e1]">
            {/* Folded Dimensions */}
            <div className="grid grid-cols-3 border-b md:border-b-0 md:border-r border-[#cbd5e1]">
              <div className=" text-[15px] md:text-[20px] text-orange-500 col-span-1 p-4 font-medium flex items-center">
              ...
              <div className="col-span-2 p-4 flex items-center font-mono text-xs md:text-sm text-[#475569]">
                L5850*W2200*H2480mm
              </div>
            </div>
            {/* Expanded Dimensions */}
          ...
          {/* Row 3: Approximate Weight & Layout */}
          <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#cbd5e1]">
            {/* Approximate Weight */}
            <div className="grid grid-cols-3 border-b md:border-b-0 md:border-r border-[#cbd5e1]">
              <div className="text-[15px] md:text-[20px] text-orange-500 col-span-1 p-4 font-medium  flex items-center">
              ...
              <div className="col-span-2 p-4 flex items-center">3.6T</div>
            </div>
            {/* Layout */}
            <div className="grid grid-cols-3">
              <div className="text-[15px] md:text-[20px] text-orange-500 col-span-1 p-4 font-medium flex items-center">
              ...
              <div className="col-span-2 p-4 flex items-center leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 min-h-[220px]">
            {/* Left Column: Broken Image Thumbnail */}
            <div className="p-6 flex items-center justify-center md:border-r border-[#cbd5e1] border-b md:border-b-0">
              <div className="w-full max-w-[320px] aspect-[4/3] border border-gray-300 bg-white flex items-center justify-start p-2 relative shadow-inner">
                {/* Broken Image Icon matching the image link placeholder */}
                <img src={love11} alt="" />
              </div>
            </div>

            {/* Right Column: Blueprint Schematic */}
            <div className="p-6 flex items-center justify-center bg-white md:bg-transparent">
              <div className="w-full max-w-[240px] aspect-square flex flex-col items-center justify-center p-2 border border-gray-100 rounded bg-white shadow-sm">
                <img src={love6} alt="" />
              </div>
            </div>
          </div>
        ...
        {/* Windows Activation Watermark Overlay */}
        <div className="absolute bottom-6 right-24 text-right text-[#94a3b8] opacity-60 select-none pointer-events-none hidden sm:block font-sans text-xs">
          <p className="text-sm font-light">Activate Windows</p>
          <p className="text-[10px]">Go to Settings to activate Windows.</p>
        </div>
      </div>
      <Table6 />
      <br />
