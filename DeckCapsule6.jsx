...
import love3 from "./picture/love3.jpg";
import love1 from './picture/love1.jpg';
import love2 from './picture/love2.jpg';
import love4 from './picture/love4.jpg';
import love5 from './picture/love5.jpg';
...
const galleryImages = [
  { title: "Exterior Resort Setup Grid View", src: love1 },
  { title: "Twin Sphere Modular High Angle Mountain Ridge", src: love2 },
  { title: "Interior Panoramic Dome View Frame", src: love3 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: love4 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: love5 },
  { title: "Lower Level Exterior Pod Foundation Setup", src: love6 },
];
  const productVideos = [
    { id: 1, title: "D8 Introduction Video", duration: "1:12" },
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start animate-layout-up">
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 leading-tight">
            Luxury Awaits in Expandable Home E20          </h1>
          <p className="text-slate-500 text-[15px] md:text-[20px] leading-relaxed max-w-2xl mx-auto lg:mx-0">
            The expansion box, or double-wing folding unit, transforms from one space into three through hinged side extensions. Popular in 20ft size, it’s ideal for offices, accommodations, and homestays. A 40HQ container can carry two 20ft units, making it a top choice for export projects.          </p>
           ...
           <div className="text-center mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-semibold tracking-tight text-slate-900">The Science Behind Our IDONGSIK Designs</h2>          
             ...
             <p className="text-[30px] sm:text-[20px] ml-auto mr-auto pt-[20px] font-semibold w-[500px] tracking-tight text-slate-500">
              Our Expandable Home E20s’ are designed
               <br/>
